...
\begin{itemize}
    \item The software system is only used in the intended software environments (unmodified iOS, Android)
    \item The software system is only used on devices that meet the minimum hardware requirements (all required sensors present)
\end{itemize}
